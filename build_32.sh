...
mv rmdisk_32/lib/modules/synobios.ko synobios.ko
rm -rf rmdisk_32/lib/modules/*
mv synobios.ko rmdisk_32/lib/modules/.
find kernel/ -iname "*.ko" -type f -exec cp -p {} rmdisk_32/lib/modules/ \;
...
#sudo cp kernel/arch/x86/boot/bzImage /mnt/img/zImage
#sudo umount /mnt/img

# build iso with grub boot
echo -e "\033[41;37m Build the ISO with grub ... \033[0m"
cp kernel/arch/x86/boot/bzImage __s54493pre_iso_grub/zImage
...
cp kernel/arch/x86/boot/bzImage __s54493pre_iso_syslinux/zImage
