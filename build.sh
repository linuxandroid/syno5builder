...
cp __s54493pre_usb.img S54493_grub.img
sudo mount -o loop,offset=32256 S54493_grub.img /mnt/img
...
mkisofs -R -J -input-charset UTF-8 -no-emul-boot -boot-load-size 4 -hide-joliet boot.catalog -boot-info-table -b grldr -hide-joliet grldr -o S54493_grub.iso __s54493pre_iso_grub/  
...
mkisofs -R -J -input-charset UTF-8 -no-emul-boot -boot-load-size 4 -hide-joliet boot.catalog -boot-info-table -b bootsec -hide-joliet bootsec -o S54493_syslinux.iso __s54493pre_iso_syslinux/
